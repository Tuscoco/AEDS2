...
class Pilha{
    ...
    public void inserir(Pokemon pok){
    ...
    public void mostrar(Celula i){
        ...
        System.out.println("[" + cont + "] " + i.elemento.toString());
        cont++;
    ...
    public static void main(String[] args) throws NumberFormatException, Exception{
        ...
        do{
            ...
            if(!isFim(str)){
                ...
                pilha.inserir(pokemons[Integer.parseInt(str) - 1].clonar());
        ...
        for(int i = 0;i < n;i++){
            ...
            if(op[0].equals("I")){
                ...
                pilha.inserir(pokemons[Integer.parseInt(op[1]) - 1].clonar());

            }else if(op[0].equals("R")){

                Pokemon temp = pilha.remover();
